            ...
            <div className='divValores'>
                  ...
                  <div>
                        <div className='divValorIndividual'>
                              ...
                              <p className='textoValor'>Proteger información personal y médica de los pacientes, garantiza que sus datos sean manejados de manera segura y privada.</p>
                        </div>

                        <div className='divValorIndividual'>
                              <p className='tituloValor'>Responsabilidad</p>
                              <p className='textoValor'>Ser responsable en la toma de decisiones médicas, asegura que todas las acciones estén orientadas al bienestar del paciente.</p>
                        </div>                    
