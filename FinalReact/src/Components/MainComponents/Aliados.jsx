...
<div>
      ...
      <div className='divCards'>
              ...
              <div className="card">
                  <img className='CepiaFoto' src={LogoCepia} alt="Logo Cepia" />
              ...
              <div className="card">
                  <img className='FoodBankFoto' src={LogoFoodBank} alt="Logo Nosara Food Bank" />
                          <div className="card-body">
              ...
              <div className="card">
                  <img className='NosaraLabFoto' src={LogoNosaraLab} alt="Logo Nosara Lab" />
                          <div className="card-body">
              ...
              <div className="card">
                  <img className='CentroRadiologicoFoto' src={LogoCentroRadiologico} alt="Logo Centro Radiológico" />
                          <div className="card-body">
              ...
              <div className="card">
                  <img className='PVMFoto' src={LogoPVM} alt="Logo Proyecto Vida" />
                          <div className="card-body">
